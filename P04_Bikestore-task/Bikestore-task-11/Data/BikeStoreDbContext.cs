...
namespace Bikestore_task_11.Data;
...
public partial class BikeStoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27A3964020");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B43D4DD34B");

            entity.ToTable("categories", "production");

            entity.Property(e => e.CategoryId).HasColumnName("category_id");
            entity.Property(e => e.Accessories).HasMaxLength(30);
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85D9DF5E44");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229A013A943");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4148B7E38");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5D5D70723");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C0CE200C8");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616409241D76").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3333AD1BB");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C8ECF4C2D");
