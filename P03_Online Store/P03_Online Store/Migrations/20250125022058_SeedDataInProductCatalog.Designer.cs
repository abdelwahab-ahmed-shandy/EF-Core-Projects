...
namespace P03_Online_Store.Migrations
{
    ...
    [Migration("20250125022058_SeedDataInProductCatalog")]
    partial class SeedDataInProductCatalog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(4958),
                            Status = 0,
                            TotalAmount = 600.5
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(5008),
                            Status = 1,
                            TotalAmount = 300.5
                        });
                });
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ShippingId = 1,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(5033),
                            CarrierName = "FedEx",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(5031),
                            OrderId = 1,
                            ShippingStatus = 0,
                        ...
                        {
                            ShippingId = 2,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(5037),
                            CarrierName = "DHL",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 20, 57, 924, DateTimeKind.Local).AddTicks(5036),
                            OrderId = 2,
                            ShippingStatus = 3,
