...
namespace P03_Online_Store.Migrations
{
    ...
    [Migration("20250125021707_SeedDataInShipping")]
    partial class SeedDataInShipping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5383),
                            Status = 0,
                            TotalAmount = 600.5
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5425),
                            Status = 1,
                            TotalAmount = 300.5
                        });
                });
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ShippingId = 1,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5452),
                            CarrierName = "FedEx",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5448),
                            OrderId = 1,
                            ShippingStatus = 0,
                        ...
                        {
                            ShippingId = 2,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5456),
                            CarrierName = "DHL",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 17, 6, 709, DateTimeKind.Local).AddTicks(5455),
                            OrderId = 2,
                            ShippingStatus = 3,
