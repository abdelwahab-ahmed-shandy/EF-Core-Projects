...
namespace P03_Online_Store.Migrations
{
    ...
    [Migration("20250125022259_SeedDataInReviewPaymentProductImage")]
    partial class SeedDataInReviewPaymentProductImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            OrderDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7887),
                            Status = 0,
                            TotalAmount = 600.5
                        },
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            OrderDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7930),
                            Status = 1,
                            TotalAmount = 300.5
                        });
                });
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TransactionDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(8072)
                        },
                        new
                        {
                            PaymentId = 2,
                            ...
                            TransactionDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(8074)
                        });
                });
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductId = 1,
                            Rating = 5.0,
                            ReviewDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(8052),
                        ...
                        new
                        {
                            ...
                            ProductId = 2,
                            Rating = 4.0,
                            ReviewDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(8056),
            ...
            modelBuilder.Entity("P03_Online_Store.Models.Shipping", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ShippingId = 1,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7957),
                            CarrierName = "FedEx",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7955),
                            OrderId = 1,
                            ShippingStatus = 0,
                        ...
                        {
                            ShippingId = 2,
                            ActualDeliveryDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7961),
                            CarrierName = "DHL",
                            EstimatedDeliveryDate = new DateTime(2025, 1, 25, 4, 22, 58, 973, DateTimeKind.Local).AddTicks(7960),
                            OrderId = 2,
                            ShippingStatus = 3,
